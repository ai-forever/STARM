...
class MuonDistMeta:
    ...
    def __init__(self, buffer_idx: int, bucket_idx: int, shape: torch.Size, global_range: Tuple[int, int],
                 tp_split_dim: int):
    ...
    def step(self):
        ...
        if self.distributed_mode:
            ...
            for p in ns_inputs.keys():
                ...
                ns_inputs[p] = ns_input_global_buffer[global_range[0] - offset: global_range[1] - offset].view(
                    dist_meta.shape)
